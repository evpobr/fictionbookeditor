...
public:
	...
	ISubMatches * GetSubMatches()
	{
		return &m_submatches;
	}
	void AddSubMatch(CString item)
	{
		m_submatches.AddItem(item);
	}
...
public:
	...
	void PutPattern(CString val)
	{
		m_pattern.SetString(val);
	}
	VARIANT_BOOL GetIgnoreCase()
	{
		return m_ignorecase;
	}
	void PutIgnoreCase(VARIANT_BOOL val)
	{
		m_ignorecase = val;
	}
	...
	void PutGlobal(VARIANT_BOOL val)
	{
		m_global = val;
	}
	...
	void PutMultiline(VARIANT_BOOL val)
	{
		m_multiline = val;
	}
