...
#ifndef __ATLIMAGEEX_H__
#define __ATLIMAGEEX_H__
...
namespace FBE
{
	...
	{
	public:
		CImageDC(const CImageEx& image) throw(...);
		~CImageDC() throw();

		operator HDC() const throw();

	private:
		const CImageEx& m_image;
		HDC m_hDC;
	};
	...
	private:
		...
		class CInitGDIPlusEx
		{
		public:
			CInitGDIPlusEx() throw();
			~CInitGDIPlusEx() throw();
	...
	private:
		...
		static CInitGDIPlusEx* GetInitGDIPlusInstance()
		{
			static CInitGDIPlusEx gdiPlus;
			return &gdiPlus;
		}
	...
	inline CImageDC::CImageDC(const CImageEx& image) throw(...) :
		m_image(image),
		m_hDC(image.GetDC())
	{
		if (m_hDC == NULL)
	...
	inline CImageEx::CInitGDIPlusEx::CInitGDIPlusEx() throw() :
	...
	inline bool CImageEx::CInitGDIPlusEx::Init() throw()
	{
	...
	inline void CImageEx::CInitGDIPlusEx::ReleaseGDIPlus() throw()
	{
		EnterCriticalSection(&m_sect);
		if (m_dwToken != 0)
		{
	...
	inline void CImageEx::CInitGDIPlusEx::IncreaseCImageCount() throw()
	{
		EnterCriticalSection(&m_sect);
		m_nCImageObjects++;
		LeaveCriticalSection(&m_sect);
	...
	inline void CImageEx::CInitGDIPlusEx::DecreaseCImageCount() throw()
	{
		EnterCriticalSection(&m_sect);
	...
	inline CImageEx::CDCCache::CDCCache() throw()
	{
		int iDC;
	...
	inline HDC CImageEx::CDCCache::GetDC() throw()
	{
		HDC hDC;
	...
	inline void CImageEx::CDCCache::ReleaseDC(HDC hDC) throw()
	{
		for (int iDC = 0; iDC < CIMAGE_DC_CACHE_SIZE; iDC++)
		{
			HDC hOldDC;
	...
	inline CImageEx::CImageEx() throw() :
		m_hBitmap(NULL),
		m_pBits(NULL),
		m_hDC(NULL),
		m_nDCRefCount(0),
	...
	inline CImageEx::operator HBITMAP() const throw()
	{
		return(m_hBitmap);
	}

#if WINVER >= 0x0500
	inline BOOL CImageEx::AlphaBlend(HDC hDestDC, int xDest, int yDest,
	...
	inline BOOL CImageEx::AlphaBlend(HDC hDestDC, const POINT& pointDest,
		BYTE bSrcAlpha, BYTE bBlendOp) const throw()
	{
	...
	inline BOOL CImageEx::AlphaBlend(HDC hDestDC, const RECT& rectDest,
	...
	inline void CImageEx::Attach(HBITMAP hBitmap, DIBOrientation eOrientation) throw()
	{
	...
	inline BOOL CImageEx::BitBlt(HDC hDestDC, int xDest, int yDest, DWORD dwROP) const throw()
	{
		return(BitBlt(hDestDC, xDest, yDest, m_nWidth, m_nHeight, 0, 0, dwROP));
	}

	inline BOOL CImageEx::BitBlt(HDC hDestDC, const POINT& pointDest, DWORD dwROP) const throw()
	{
		return(BitBlt(hDestDC, pointDest.x, pointDest.y, m_nWidth, m_nHeight,
			0, 0, dwROP));
	}

	inline BOOL CImageEx::BitBlt(HDC hDestDC, int xDest, int yDest, int nDestWidth,
	...
	inline BOOL CImageEx::BitBlt(HDC hDestDC, const RECT& rectDest,
	...
	inline BOOL CImageEx::Create(int nWidth, int nHeight, int nBPP, DWORD dwFlags) throw()
	{
		return(CreateEx(nWidth, nHeight, nBPP, BI_RGB, NULL, dwFlags));
	}

	inline BOOL CImageEx::CreateEx(int nWidth, int nHeight, int nBPP, DWORD eCompression,
...
#pragma warning(pop)
	...
	inline void CImageEx::Destroy() throw()
	{
		HBITMAP hBitmap;
	...
	inline HBITMAP CImageEx::Detach() throw()
	{
		HBITMAP hBitmap;
	...
	inline BOOL CImageEx::Draw(HDC hDestDC, const RECT& rectDest) const throw()
	{
	...
	inline BOOL CImageEx::Draw(HDC hDestDC, int xDest, int yDest, int nDestWidth, int nDestHeight) const throw()
	{
		return(Draw(hDestDC, xDest, yDest, nDestWidth, nDestHeight, 0, 0, m_nWidth, m_nHeight));
	}

	inline BOOL CImageEx::Draw(HDC hDestDC, const POINT& pointDest) const throw()
	{
		return(Draw(hDestDC, pointDest.x, pointDest.y, m_nWidth, m_nHeight, 0, 0, m_nWidth, m_nHeight));
	}

	inline BOOL CImageEx::Draw(HDC hDestDC, int xDest, int yDest) const throw()
	{
		return(Draw(hDestDC, xDest, yDest, m_nWidth, m_nHeight, 0, 0, m_nWidth, m_nHeight));
	}

	inline BOOL CImageEx::Draw(HDC hDestDC, const RECT& rectDest, const RECT& rectSrc) const throw()
	{
		return(Draw(hDestDC, rectDest.left, rectDest.top, rectDest.right -
			rectDest.left, rectDest.bottom - rectDest.top, rectSrc.left, rectSrc.top,
	...
	inline BOOL CImageEx::Draw(HDC hDestDC, int xDest, int yDest, int nDestWidth,
		int nDestHeight, int xSrc, int ySrc, int nSrcWidth, int nSrcHeight) const throw()
	{
		BOOL bResult;
	...
	inline const void* CImageEx::GetBits() const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
	...
	inline void* CImageEx::GetBits() throw()
	{
		ATLASSUME(m_hBitmap != NULL);
		ATLASSERT(IsDIBSection());
	...
	inline int CImageEx::GetBPP() const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
	...
	inline void CImageEx::GetColorTable(UINT iFirstColor, UINT nColors,
	...
	inline HDC CImageEx::GetDC() const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
	...
	inline bool CImageEx::ShouldExcludeFormat(REFGUID guidFileType, DWORD dwExclude) throw()
	{
	...
	inline void CImageEx::BuildCodecFilterString(const Gdiplus::ImageCodecInfo* pCodecs, UINT nCodecs,
	...
	inline HRESULT CImageEx::GetImporterFilterString(CSimpleString& strImporters,
		CSimpleArray< GUID >& aguidFileTypes, LPCTSTR pszAllFilesDescription /* = NULL */,
	...
	inline HRESULT CImageEx::GetExporterFilterString(CSimpleString& strExporters,
		CSimpleArray< GUID >& aguidFileTypes, LPCTSTR pszAllFilesDescription /* = NULL */,
	...
	inline int CImageEx::GetHeight() const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
	...
	inline int CImageEx::GetMaxColorTableEntries() const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
		ATLASSERT(IsDIBSection());
	...
	inline int CImageEx::GetPitch() const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
		ATLASSERT(IsDIBSection());
	...
	inline COLORREF CImageEx::GetPixel(int x, int y) const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
	...
	inline const void* CImageEx::GetPixelAddress(int x, int y) const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
		ATLASSERT(IsDIBSection());
		ATLASSERT((x >= 0) && (x < m_nWidth));
	...
	inline void* CImageEx::GetPixelAddress(int x, int y) throw()
	{
		ATLASSUME(m_hBitmap != NULL);
		ATLASSERT(IsDIBSection());
		ATLASSERT((x >= 0) && (x < m_nWidth));
	...
	inline LONG CImageEx::GetTransparentColor() const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
	...
	inline int CImageEx::GetWidth() const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
	...
	inline bool CImageEx::IsDIBSection() const throw()
	{
		return(m_bIsDIBSection);
	}

	inline bool CImageEx::IsIndexed() const throw()
	{
		ATLASSUME(m_hBitmap != NULL);
		ATLASSERT(IsDIBSection());
	...
	inline bool CImageEx::IsNull() const throw()
	{
		return(m_hBitmap == NULL);
	}

	inline HRESULT CImageEx::Load(IStream* pStream) throw()
	{
		if (!InitGDIPlus())
		{
			return(E_FAIL);
	...
	inline HRESULT CImageEx::Load(LPCTSTR pszFileName) throw()
	{
		if (!InitGDIPlus())
		{
			return(E_FAIL);
	...
	inline HRESULT CImageEx::CreateFromGdiplusBitmap(Gdiplus::Bitmap& bmSrc) throw()
	{
	...
	inline void CImageEx::LoadFromResource(HINSTANCE hInstance, LPCTSTR pszResourceName) throw()
	{
		HBITMAP hBitmap;
	...
	inline void CImageEx::LoadFromResource(HINSTANCE hInstance, UINT nIDResource) throw()
	{
		LoadFromResource(hInstance, MAKEINTRESOURCE(nIDResource));
	}

	inline BOOL CImageEx::MaskBlt(HDC hDestDC, int xDest, int yDest, int nWidth,
	...
	inline BOOL CImageEx::MaskBlt(HDC hDestDC, const RECT& rectDest,
	...
	inline BOOL CImageEx::MaskBlt(HDC hDestDC, int xDest, int yDest, HBITMAP hbmMask,
		DWORD dwROP) const throw()
	{
	...
	inline BOOL CImageEx::MaskBlt(HDC hDestDC, const POINT& pointDest, HBITMAP hbmMask,
		DWORD dwROP) const throw()
	{
	...
	inline BOOL CImageEx::PlgBlt(HDC hDestDC, const POINT* pPoints, int xSrc,
	...
	inline void CImageEx::ReleaseDC() const throw()
	{
		HBITMAP hBitmap;
	...
	inline CLSID CImageEx::FindCodecForExtension(LPCTSTR pszExtension, const Gdiplus::ImageCodecInfo* pCodecs, UINT nCodecs)
	{
	...
	inline CLSID CImageEx::FindCodecForFileType(REFGUID guidFileType, const Gdiplus::ImageCodecInfo* pCodecs, UINT nCodecs)
	{
		for (UINT iCodec = 0; iCodec < nCodecs; iCodec++)
		{
	...
	inline HRESULT CImageEx::Save(IStream* pStream, REFGUID guidFileType) const throw()
	{
		if (!InitGDIPlus())
		{
			return(E_FAIL);
	...
	inline HRESULT CImageEx::Save(LPCTSTR pszFileName, REFGUID guidFileType, Gdiplus::EncoderParameters* encoderParameters) const throw()
	{
		if (!InitGDIPlus())
		{
			return(E_FAIL);
	...
	inline void CImageEx::SetColorTable(UINT iFirstColor, UINT nColors,
		const RGBQUAD* prgbColors) throw()
	{
		ATLASSUME(m_hBitmap != NULL);
		ATLASSERT(IsDIBSection());
	...
	inline void CImageEx::SetPixel(int x, int y, COLORREF color) throw()
	{
		ATLASSUME(m_hBitmap != NULL);
		ATLASSERT((x >= 0) && (x < m_nWidth));
		ATLASSERT((y >= 0) && (y < m_nHeight));
	...
	inline void CImageEx::SetPixelIndexed(int x, int y, int iIndex) throw()
	{
		SetPixel(x, y, PALETTEINDEX(iIndex));
	}

	inline void CImageEx::SetPixelRGB(int x, int y, BYTE r, BYTE g, BYTE b) throw()
	{
		SetPixel(x, y, RGB(r, g, b));
	}

	inline LONG CImageEx::SetTransparentColor(LONG iTransparentColor) throw()
	{
	...
	inline BOOL CImageEx::StretchBlt(HDC hDestDC, int xDest, int yDest,
	...
	inline BOOL CImageEx::StretchBlt(HDC hDestDC, const RECT& rectDest,
		DWORD dwROP) const throw()
	{
...
#if WINVER >= 0x0500
	inline BOOL CImageEx::TransparentBlt(HDC hDestDC, int xDest, int yDest,
	...
	inline BOOL CImageEx::TransparentBlt(HDC hDestDC, const RECT& rectDest,
	...
	inline BOOL CImageEx::IsTransparencySupported() throw()
	{
		return(TRUE);
	}

	inline void CImageEx::UpdateBitmapInfo(DIBOrientation eOrientation)
	{
	...
	inline void CImageEx::GenerateHalftonePalette(LPRGBQUAD prgbPalette)
	{
		int r;
		int g;
		int b;
	...
	inline COLORREF CImageEx::GetTransparentRGB() const
	{
		RGBQUAD rgb;
	...
	inline bool CImageEx::InitGDIPlus() throw()
	{
